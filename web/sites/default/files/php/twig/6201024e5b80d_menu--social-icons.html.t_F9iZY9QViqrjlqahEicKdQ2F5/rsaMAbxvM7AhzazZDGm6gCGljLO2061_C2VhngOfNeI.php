...
/* themes/custom/the_wire/templates/menu--social-icons.html.twig */
class __TwigTemplate_4240a2e98a1d8903bbc99944c80a4b1ecca832b87989cfabb3851523cd7dc8ac extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "social-icons"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 38
                    echo "      <li";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 38), "addClass", [0 => "social-icons-items"], "method", false, false, true, 38), 38, $this->source), "html", null, true);
                    echo ">
        ";
                    // line 39
  ...
  ";
    ...
    {
        return "themes/custom/the_wire/templates/menu--social-icons.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('social-icons') }}>
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
      <li{{ item.attributes.addClass('social-icons-items') }}>
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/the_wire/templates/menu--social-icons.html.twig", "/var/www/html/the_wire/web/themes/custom/the_wire/templates/menu--social-icons.html.twig");
    }
