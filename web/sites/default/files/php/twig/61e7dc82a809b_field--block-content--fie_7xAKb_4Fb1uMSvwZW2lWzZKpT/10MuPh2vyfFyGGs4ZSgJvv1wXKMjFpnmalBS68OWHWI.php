...
/* themes/custom/the_wire/templates/field--block-content--field-logo.html.twig */
class __TwigTemplate_a77251c41653ed773df74b71c92d368ab5ec4a162b3d11401057b863f16f0ca7 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_b8a44bb7188f10fa054f3681425c559c29de95cd0490f5c67a67412aafc0f453->enter($__internal_b8a44bb7188f10fa054f3681425c559c29de95cd0490f5c67a67412aafc0f453_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "themes/custom/the_wire/templates/field--block-content--field-logo.html.twig"));
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 54
                    echo "      <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "site-logo-wrapper"], "method", false, false, true, 54), 54, $this->source), "html", null, true);
                    echo ">";
...
";
    ...
    {
        return "themes/custom/the_wire/templates/field--block-content--field-logo.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass('site-logo-wrapper') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
  <div{{ attributes }}>
...
{% endif %}
", "themes/custom/the_wire/templates/field--block-content--field-logo.html.twig", "/var/www/html/the_wire/web/themes/custom/the_wire/templates/field--block-content--field-logo.html.twig");
    }
