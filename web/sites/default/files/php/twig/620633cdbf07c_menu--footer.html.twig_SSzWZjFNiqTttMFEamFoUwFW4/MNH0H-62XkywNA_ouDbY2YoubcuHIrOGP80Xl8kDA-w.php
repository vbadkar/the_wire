...
/* themes/custom/the_wire/templates/menu--footer.html.twig */
class __TwigTemplate_a4029f989f064b09ac74d13d6f9f74cb30b895f4a1822ab8f8bf985fbc0d1736 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "nav-bar-footer"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 38
                    echo "      <li";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 38), "addClass", [0 => "nav-list-items-footer"], "method", false, false, true, 38), 38, $this->source), "html", null, true);
                    echo ">
        ";
                    // line 39
  ...
  ";
    ...
    {
        return "themes/custom/the_wire/templates/menu--footer.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('nav-bar-footer') }}>
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
      <li{{ item.attributes.addClass('nav-list-items-footer') }}>
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/the_wire/templates/menu--footer.html.twig", "/var/www/html/the_wire/web/themes/custom/the_wire/templates/menu--footer.html.twig");
    }
