...
;
(function(c,a){function b(d,e){c(e).slick()}a.behaviors.slickVanilla={attach:function(e){var d=c(".slick-vanilla",e);if(d&&d.length){d.once("slick-vanilla").each(b)}}}})(jQuery,Drupal);
;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
